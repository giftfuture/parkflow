...
import cn.chinaflame.park.util.ProcessInstanceDiagramCmd;
import cn.chinaflame.park.util.Util;
import cn.chinaflame.park.util.WorkflowUtils;  
/**
 * 流程管理控制器
 *
 */
...
public class ActivitiController extends BaseController{
    ...
    public void graphics(String definitionId, String instanceId,String taskId, ModelAndView mav, HttpServletResponse response)  
            throws IOException {  
