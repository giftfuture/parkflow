...
public class ProcessDefinitionGeneratorEx {
	  ...
	  private RuntimeService runtimeService;  
	    ...
	    public InputStream generateDiagramWithHighLight(String processInstanceId) throws IOException {  
	        ...
	        List<String> activeActivityIds = WorkflowUtils.getActiveActivityIds(runtimeService, processInstanceId);  
	        List<ActivityImpl> definitionActivities = WorkflowUtils.getFlatAllActivities(definition);  
